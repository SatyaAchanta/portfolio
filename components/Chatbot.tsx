    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 z-50 w-16 h-16 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white rounded-full shadow-2xl flex items-center justify-center transition-all transform hover:scale-110 active:scale-95 group"
          ...
          <div className="bg-gradient-to-r from-amber-500 to-orange-500 px-6 py-4 border-b border-slate-700 flex items-center justify-between">
            <div className="flex-1">
              <h3 className="text-white font-semibold text-lg flex items-center gap-2">
                ...
                I am Satya&apos;s Assistant
              </h3>
              <p className="text-amber-100 text-xs mt-1">Ask me anything about my portfolio</p>
            </div>
            <button
