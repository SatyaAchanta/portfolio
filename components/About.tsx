              ...
              <div className="flex flex-col md:flex-row gap-8 items-center">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                    I deliver scalable, testable, and maintainable applications
                    by fostering trust and teamwork. With 10+ years of
                    experience, I specialize in modernizing large-scale web
                    platforms, building CI/CD pipelines, and migrating legacy
                    services to cloud-native architectures. I&apos;m passionate
                    about reducing knowledge silos through documentation,
                    automation, and continuous feedback.
                  </p>
                  <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                    Currently at <strong>Ithaka</strong>, I work with the
                    library team within JSTOR&apos;s Front-end organization,
                    mentor junior engineers, and introduced a real-time feedback
                    widget that cut the end-user feedback loop by 50%. I&apos;m
                    also a CKAD-certified engineer and active contributor to
