...
export default function Projects() {
  ...
  const fantasyLeagueDesc = "Built and launched a prediction-based fantasy cricket platform for Michigan Cricket Association fans, enabling users to predict match outcomes, track leaderboards, and compete across weekly rounds. Designed to bring community engagement and data transparency to local cricket enthusiasts.";
  
  const portfolioDesc = "A story-driven personal platform built with Next.js 16 and Tailwind CSS v4, orchestrating a cohesive narrative for career achievements, projects, and certifications. Framer Motion micro-interactions, MUI call-to-actions, and a floating AI assistant create a responsive, always-on discovery experience for recruiters and collaborators.";
          ...
          <div className="max-w-5xl mx-auto">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="bg-gradient-to-r from-green-900/20 to-emerald-900/20 p-4 rounded-lg border-l-4 border-green-500">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h4 className="font-bold text-white text-sm md:text-base">Performance Impact</h4>
                      </div>
                      <p className="text-sm md:text-base text-gray-300">
                        <span className="hidden md:inline">Reduced result calculation time from </span>
                        <strong>30 min → 15 sec</strong>
                        <span className="hidden md:inline"> by engineering an automated scoring pipeline</span>
                      </p>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-blue-900/20 to-cyan-900/20 p-4 rounded-lg border-l-4 border-blue-500">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h4 className="font-bold text-white text-sm md:text-base">Modern Stack</h4>
                      </div>
                      <p className="text-sm md:text-base text-gray-300">
                        <strong>Next.js, TypeScript, Prisma</strong>
                        <span className="hidden md:inline">, Neon Postgres and deployed on Vercel with Clerk Authentication</span>
                      </p>
                    </div>
                  </div>

                  <div className="bg-gray-800 rounded-lg p-4 md:p-6">
                    <h4 className="font-bold text-white mb-4 text-sm md:text-base">Key Achievements:</h4>
                    <ExpandableList items={fantasyHighlights} initialCount={2} />
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="bg-gradient-to-r from-slate-900/20 to-sky-900/20 p-4 rounded-lg border-l-4 border-sky-500">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h4 className="font-bold text-white text-sm md:text-base">Immersive Presentation</h4>
                      </div>
                      <p className="text-sm md:text-base text-gray-300">
                        Hero gradients, animated timelines, and modular sections
                        <span className="hidden md:inline"> tailor the messaging across desktop and mobile touchpoints</span>
                      </p>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-indigo-900/20 to-purple-900/20 p-4 rounded-lg border-l-4 border-indigo-500">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h4 className="font-bold text-white text-sm md:text-base">AI-Ready Architecture</h4>
                      </div>
                      <p className="text-sm md:text-base text-gray-300">
                        Chat API routes
                        <span className="hidden md:inline">, OpenAI streaming, and resume-driven content pipelines lay the groundwork for intelligent Q&A experiences</span>
                      </p>
                    </div>
                  </div>

                  <div className="bg-gray-800 rounded-lg p-4 md:p-6">
                    <h4 className="font-bold text-white mb-4 text-sm md:text-base">Key Highlights:</h4>
                    <ExpandableList items={portfolioHighlights} initialCount={2} />
                  </div>
            ...
            >
              ...
              <p className="text-sm md:text-base text-gray-300 leading-relaxed">
                <strong>Next Goal:</strong> <span className="hidden md:inline">Introduce an </span>AI Chatbot in Fantasy League
                <span className="hidden md:inline"> website to enable users to make predictions, view standings, and get AI-based suggestions through conversational interface</span>
              </p>
            </motion.div>
