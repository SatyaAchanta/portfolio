              ...
              <div className="bg-gray-900 p-8 md:p-10 rounded-xl">
                <div className="flex flex-col md:flex-row gap-6 items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="bg-gradient-to-r from-purple-900/20 to-blue-900/20 p-6 rounded-lg border-l-4 border-purple-600">
                    ...
                    <div className="mt-6 grid grid-cols-2 md:grid-cols-3 gap-4">
                      <div className="text-center p-3 bg-gray-800 rounded-lg">
                        <div className="text-2xl font-bold text-purple-400">3.75</div>
                        <div className="text-xs text-gray-400">GPA</div>
                      </div>
                      <div className="text-center p-3 bg-gray-800 rounded-lg">
                        <div className="text-2xl font-bold text-blue-400">CS</div>
                        <div className="text-xs text-gray-400">Major</div>
                      </div>
                      <div className="text-center p-3 bg-gray-800 rounded-lg col-span-2 md:col-span-1">
                        <div className="text-2xl font-bold text-green-400">Graduate</div>
                        <div className="text-xs text-gray-400">Degree Level</div>
                      </div>
                    </div>
                  </div>
                </div>
